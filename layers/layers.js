...
var lyr_2022_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/2022_2_1.png" /> 77,4 - 86<br />\
    <img src="styles/legend/2022_2_2.png" /> 86 - 91<br />\
    <img src="styles/legend/2022_2_3.png" /> 91 - 94<br />\
    <img src="styles/legend/2022_2_4.png" /> 94 - 98<br />'
        });
...
var lyr_2023_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/2023_3_1.png" /> 77,8 - 85,8<br />\
    <img src="styles/legend/2023_3_2.png" /> 85,8 - 90,4<br />\
...
lyr_2021_1.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'objective': 'objective', });
lyr_2022_2.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'objective': 'objective', });
lyr_2023_3.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'objective': 'objective', });
lyr_2021_1.set('fieldImages', {'PROVINSI': 'TextEdit', 'objective': 'TextEdit', });
lyr_2022_2.set('fieldImages', {'PROVINSI': 'TextEdit', 'objective': 'TextEdit', });
lyr_2023_3.set('fieldImages', {'PROVINSI': 'TextEdit', 'objective': 'TextEdit', });
lyr_2021_1.set('fieldLabels', {'PROVINSI': 'no label', 'objective': 'no label', });
lyr_2022_2.set('fieldLabels', {'PROVINSI': 'no label', 'objective': 'no label', });
lyr_2023_3.set('fieldLabels', {'PROVINSI': 'no label', 'objective': 'no label', });
