...
var style_2023_3 = function(feature, resolution){
    ...
    var value = feature.get("objective");
    var labelText = "";
    size = 0;
    ...
    if (value >= 66.000000 && value <= 77.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 77.800000 && value <= 85.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 85.800000 && value <= 90.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 90.400000 && value <= 93.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 93.600000 && value <= 99.000000) {
            style = [ new ol.style.Style({
